	...
	$.obj = {
	    ...
	    make: function make() {
	        ...
	        for (var i = 0; i < arguments.length; i += 2) {
	            obj[arguments.length <= i + 0 ? undefined : arguments[i + 0]] = arguments.length <= i + 1 + 0 ? undefined : arguments[i + 1 + 0];
	        }
	        return obj;
	    },
